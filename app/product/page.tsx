      ...
      <section className="panel phero">
        <div className="container">
          ...
          <p className="lede phero__lede">
            omyt isn&rsquo;t a tool you check, it&rsquo;s a company brain that runs. Five systems
            feed one model of your business, one brain reasons across all of it, and one closed loop
            ...
            <Reveal delay={100} className="show__media">
              <div className="term">
                <div className="term__bar">
                  <b /> brain // decision.log
                </div>
                <div className="term__body">
                  <div className="trow" style={{ display: "block" }}>
                    <div className="trow__t">&ldquo;Push Acme this week.&rdquo;</div>
                    <div className="trow__s" style={{ lineHeight: 1.6, marginTop: 8 }}>
                      3 pricing visits / 5d · champion re-engaged · macro tailwind in sector.
                      Highest expected-value move in the model right now.
                    </div>
        ...
        <div className="container">
          <div className="sec">
            ...
            <p className="sec__lede lede">
              omyt fuses three signal types into one semantic model. That fusion — not another
              dashboard — is what lets it reason about your world instead of reciting it.
            </p>
          </div>
        ...
        <div className="container">
          <div className="show show--flip">
            <Reveal className="show__media">
              <div className="term">
                <div className="term__bar">
                  <b /> deliverability // protected
                </div>
                <div className="term__body">
                  <div className="trow" style={{ display: "block" }}>
                    <div className="trow__s">today&rsquo;s send budget</div>
                    <div className="trow__t" style={{ fontSize: "1.8rem", marginTop: 4 }}>
                      42 / 50
                    </div>
                  ...
                  <div className="trow">
                    <div>
                      <div className="trow__t">bounce rate (7d)</div>
                      <div className="trow__s">circuit breaker armed</div>
                    </div>
                    <span className="stat-tag stat-tag--acc">0.4% ok</span>
                  </div>
                  <div className="trow">
                    <div>
                      <div className="trow__t">suppression list</div>
                      <div className="trow__s">unsubscribes + bounces</div>
                    </div>
                    <span className="stat-tag">enforced</span>
                  </div>
                </div>
              </div>
            </Reveal>
            <Reveal delay={100}>
              ...
              <p className="show__p">
                Email-first sequences build lists, personalize, send, and route replies on their own
                — inside deliverability guardrails that protect your domain without you thinking
                about it.
              </p>
              <ul className="show__list">
      ...
      <section className="panel section">
        <div className="container">
          <div className="sec">
            ...
            <p className="sec__lede lede">
              The model is governed, not improvised. You hold the controls; it compounds within
              them.
            </p>
          </div>
      ...
      <section className="panel section">
        <div className="container">
          ...
          <div className="cta__row">
            <p className="cta__p">
              Request an invite. We build brains in small waves and reach out when yours is ready.
            </p>
...
const SYSTEMS = [
  {
    t: "Outreach",
    d: "Email-first sequences with list-building, enrichment, and reply handling — all feeding the model.",
  },
  {
    t: "Pipeline",
    d: "A CRM that's the real source of truth — every touch and stage, held and scored in the model.",
  },
  { t: "Automations", d: "Background work that runs itself inside guardrails you control." },
  {
    t: "Strategy",
    d: "ICP, positioning, moat, risks, plays, and a 90-day plan kept honest by real data.",
  },
...
const TRIAD = [
  {
    k: "μ",
    t: "Micro signals",
    d: "Contact- and deal-level signals — engagement, intent, silence, momentum — at the resolution of a single relationship.",
  },
  {
    k: "Μ",
    t: "Macro signals",
    d: "Market and industry trends, shocks, and timing windows. The conditions your accounts are buying in, not just who they are.",
  },
  {
    k: "e²",
    t: "Experience²",
    d: "Interaction history compounded into judgment — what messaging, timing, and sequencing actually convert for you.",
  },
];
...
const GOVERN = [
  {
    t: "Freeze & unfreeze",
    d: "Lock your strategy when it's set. When you unfreeze, the model proposes changes for review — never silent edits.",
  },
  {
    t: "Approve or veto",
    d: "Every suggestion is granular. Accept what's right, veto what isn't — and vetoes are logged to refine what comes next.",
  },
  {
    t: "Closed-loop learning",
    d: "Won, lost, replied, ignored — every outcome folds back into the model and orbits your North Star.",
  },
  {
    t: "One North Star",
    d: "A single six-month goal anchors the whole engine, so every automation and play pulls in the same direction.",
  },
];
